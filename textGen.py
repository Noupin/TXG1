...
try:
    ...
    model.save(rf"C:\Coding\Python\ML\Text\Models\STS1_CharGen_{config.batch_size}Batch_{config.maxlen}Maxlen_{config.remeberChars}Remem_{config.epochs}Epochs.model")
except:
    model.save(rf"C:\Coding\Python\ML\Text\Models\STS1_CharGen_{config.batch_size}Batch_{config.maxlen}Maxlen_{config.remeberChars}Remem_{config.epochs}Epochs.model")
